...
When contributing to Budget, please first discuss the change you wish to make
...
```sh
git clone https://github.com/tristandunn/budget
```
...
You can verify everything is installed and set up correctly by running
`bin/ci` to run the tests and all other checks.
...
Issues](https://github.com/tristandunn/budget/issues). Before you create an
...
1. Search our repository for open or closed [pull
   requests](https://github.com/tristandunn/budget/pulls) that relate to your
