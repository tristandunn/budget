...
describe TransactionsController, type: :routing do
  ...
  it do
    expect(described_class).to route(:patch, "/budgets/1/transactions/1/clear")
      .to(action: :clear, budget_id: 1, id: 1)
  end

  it do
    expect(described_class).to route(:delete, "/budgets/1/transactions/1/clear")
      .to(action: :unclear, budget_id: 1, id: 1)
  end
end
