...
/*
 * Validates the transaction form before submission. Asks each required
 * picker to validate itself and checks the amount is a non-zero number;
 * cancels the submit when any required field is missing so the user can
 * see which fields need a value.
 */
