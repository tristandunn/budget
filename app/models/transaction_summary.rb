...
class TransactionSummary
  ...
  # Initialize the transaction summary.
  #
  # @param budget [Budget] The budget owning the selected transactions.
  # @param ids [Array<Integer, String>] The IDs of the selected transactions.
